...
@section('content')
    ...
    <!-- Modal -->
    <div class="modal fade" id="modal_1" tabindex="-1" role="dialog" aria-labelledby="modal_5"
        aria-hidden="true">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control text-capitalize" id="p_name" placeholder="Nama Product" name="p_name" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="img-preview" style="margin-top: 10px">
                                                <img src="{{ asset('images/shop/items/1.jpg') }}" id="preview" width="100%" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
