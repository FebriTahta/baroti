        ...
        <div class="container-fluid">
            <div class="row clearfix">
                ...
                <div class="col-xl-8">
                    <div class="card">
                        <div class="header" style="background-color: rgb(125, 51, 243);">
                            <h2 style="color: white;">AJAKAN</h2>
                        </div>
                        @if ($ajakan !== null)
                        <div class="body">
                            <form id="formadd2" method="POST"> @csrf
                                {{-- <form action="/tes" method="POST"> @csrf --}}
                                <div class="form-group">
                                    <label for="">JUDUL</label>
                                    <input type="text" class="form-control" value="{{ $ajakan->judul }}" name="judul"
                                        required>
                                </div>
                                <div class="form-group">
                                    <label for="">HEADING</label>
                                    <input type="text" class="form-control" value="{{ $ajakan->heading }}"
                                        name="heading" required>
                                </div>
                                <div class="form-group">
                                    <label for="">TEXT SINGKAT</label>
                                    <input type="text" class="form-control" name="deskripsi"
                                        value="{{ $ajakan->deskripsi }}" required>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select class="form-control show-tick ms select2" name="linkbutton_id[]" multiple
                                        ...
                                        @foreach ($linkbutton as $item)
                                            <option value="{{ $item->id }}"
                                                @foreach ($ajakan->linkbutton as $value) 
                                                    @if ($item->id == $value->id)
                                                        selected 
                                                    @endif
                                                @endforeach
                                ...
                                <div class="form-gourp">
                                    <input type="submit" class="btn btn-sm btn-primary" value="SUBMIT AJAKAN"
                                        id="addajakan">
                                </div>
                            </form>
                        </div>
