                        ...
                        <div class="body">
                            ...
                            <form id="formadd" method="POST"> @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="summernote" name="deskirpsi" id="deskirpsi" cols="30" rows="10"></textarea>
                                </div>
                                <div class="form-group">
                                    <p>- IMAGE (700 * 800 PIXEL)</p>
                                ...
                                <div class="form-group">
                                    <div class="preview">
                                        <img style="max-width: 100%" id="inputGroupFile01-preview" src="{{asset('images/image-02.png')}}">
                                    </div>
                                </div>                                
                                <div class="form-group">
                            ...
                            <form id="formadd" method="POST"> @csrf
                                <div class="form-group">
                                    <label>JUDUL</label>
                                    <input type="text" name="judul" id="judul" value="{{$about->judul}}" class="form-control text-capitalize" placeholder="" required>
                                </div>
                                <div class="form-group">
                                    <label>DESKRIPSI</label>
                                    <textarea class="summernote" name="deskirpsi" id="deskirpsi" cols="30" rows="10">{{$about->deskirpsi}}</textarea>
                                </div>
                                <div class="form-group">
                                    <p>- IMAGE (700 * 800 PIXEL)</p>
                                    <div class="input-group mb-3">
                                ...
                                <div class="form-group">
                                    <div class="preview">
                                        <img style="max-width: 100%" id="inputGroupFile01-preview" src="{{asset('img_about/'.$about->img)}}">
                                    </div>
                                </div>                                
                                <div class="form-group">
                                    <input type="submit" id="btnadd" class="btn btn-info form-control" value="SUBMIT!"
        ...
        $('#formadd').submit(function(e) {
            ...
            $.ajax({
                ...
                beforeSend: function() {
                    ...
                    $('#btnadd').val('Process Adding About');
                },
                success: function(response) {
                    if (response.status == 200) {
                        // window.location.reload();
