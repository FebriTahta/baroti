                ...
                <form id="formdel" method="POST"> @csrf
                    <div class="modal-body">
                        <div class="py-3 text-center">
                            ...
                            <h4 class="heading mt-4">Yakin Menghapus Tag Ini?</h4>
                            <p>Tag Tersebut akan dihapus, Product Dengan Tag Tersebut akan Kehilangan Tagnya</p>
                        </div>
