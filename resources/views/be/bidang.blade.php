                    ...
                    <div class="card">
                        <div class="body">
                            ...
                            <form id="formadd" method="POST"> @csrf
                                <div class="form-group">
                                    <label>JUDUL</label>
                                    <input type="text" name="judul" id="judul" value="{{$bidang->judul}}" class="form-control text-capitalize" placeholder="" required>
                                </div>
                                <div class="form-group">
                                    <label>DESKRIPSI</label>
                                    <textarea class="summernote" name="deskripsi" id="deskripsi" cols="30" rows="10">{{$bidang->deskripsi}}</textarea>
                                </div>
        ...
        $('#formadd').submit(function(e) {
            ...
            $.ajax({
                ...
                beforeSend: function() {
                    ...
                    $('#btnadd').val('Process Adding Bidang');
                },
                success: function(response) {
                    if (response.status == 200) {
                        // window.location.reload();
